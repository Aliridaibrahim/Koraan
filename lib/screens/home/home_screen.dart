...
import 'package:koraan/share_icon.dart';
import 'package:koraan/utils/assets.dart';
...
import '../../widgets/calligrafy.dart';
import '../../widgets/quarn_rail.dart';
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, _) {
            return Material(
              ...
              color: appProvider.isDark ? Colors.purple[900] : Colors.blue,
              child: Stack(
                children: <Widget>[
                  Transform.translate(
                    offset: Offset(
